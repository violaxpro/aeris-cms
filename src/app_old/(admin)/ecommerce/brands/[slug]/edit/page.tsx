...
import { productData } from '@/app_old/shared/ecommerce/product/create-edit/form-utils';
import CreateEditProduct from '@/app_old/shared/ecommerce/product/create-edit';
...
export default function EditProductPage({
  ...
  return (
    <>
      ...
      <CreateEditBrands slug={params.slug} />
    </>
  );
}
