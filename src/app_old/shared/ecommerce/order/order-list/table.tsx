...
import { getColumns } from '@/app_old/shared/ecommerce/order/order-list/columns';
import { ActionIcon } from 'rizzui';
import cn from '@/core/utils/class-names';
import ExpandedOrderRow from '@/app_old/shared/ecommerce/order/order-list/expanded-row';
// dynamic import
const FilterElement = dynamic(
  () => import('@/app_old/shared/ecommerce/order/order-list/filter-element'),
  { ssr: false }
);
