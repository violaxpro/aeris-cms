    ...
    },
    {
      title: (
        <HeaderCell
          ...
          sortable
          ascending={
            sortConfig?.direction === 'asc' && sortConfig?.key === 'optionType'
          }
        />
      ),
      onHeaderCell: () => onHeaderCellClick('optionType'),
        ...
        <div className="flex items-center justify-end gap-3 pe-4">
          ...
          >
            <Link href={routes.eCommerce.editOptions(row.id)}>
              <ActionIcon size="sm" variant="outline" aria-label={'Edit Option'}>
          ...
          <DeletePopover
            ...
            description={`Are you sure you want to delete this #${row.id} option?`}
