...
const FilterElement = dynamic(
  () => import('@/app_old/shared/ecommerce/product/product-list/filter-element'),
  { ssr: false }
);
...
export default function PriceLevelTable() {
  ...
  const {
    ...
    handleDelete,
    handleReset,
  } = useTable(priceLevelsData, pageSize, filterState);
