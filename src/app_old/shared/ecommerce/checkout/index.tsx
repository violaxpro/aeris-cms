...
import DifferentBillingAddress from '@/app_old/shared/ecommerce/order/order-form/different-billing-address';
import { orderData } from '@/app_old/shared/ecommerce/order/order-form/form-utils';
import AddressInfo from '@/app_old/shared/ecommerce/order/order-form/address-info';
import ShippingMethod from '@/app_old/shared/ecommerce/checkout/shipping-method';
import PaymentMethod from '@/app_old/shared/ecommerce/checkout/payment-method';
import OrderSummery from '@/app_old/shared/ecommerce/checkout/order-summery';
import OrderNote from '@/app_old/shared/ecommerce/checkout/order-note';
...
import {
  CreateOrderInput,
  orderFormSchema,
} from '@/plugins/validators/create-order.schema';
