...
import { SearchIcon, SearchHeaderIcon } from '@public/icon';
    ...
    return (
        ...
        <div className='w-full'>
            ...
            <div className="relative">
                ...
                />
                <button type="submit"
                    className="text-white absolute end-2.5 bottom-1.5 bg-[#0A3353] hover:bg-[#0A3353] focus:ring-4 focus:outline-none focus:ring-[#0A3353] font-medium rounded-lg text-sm px-2 py-1 dark:bg-[#0A3353] dark:hover:bg-[#0A3353] dark:focus:ring-[#0A3353]">
                    <Image
                        src={SearchHeaderIcon}
