...
import { FaqType, dummyFaq } from '@/plugins/types/management-type'
import { faqAtom } from '@/store/FaqAtom'
...
const index = ({ faqDatas }: { faqDatas?: any }) => {
    const router = useRouter()
    const { contextHolder, notifySuccess } = useNotificationAntd()
    const [data, setData] = useAtom(faqAtom)
    ...
    const columns: TableColumnsType<FaqType> = [
        {
            title: 'Category',
            dataIndex: 'category',
            sorter: (a: any, b: any) => {
    ...
    return (
        <>
            ...
            />
            <ModalFaq
                isModalOpen={openModalFaq}
                handleCancel={() => setOpenModalFaq(false)}
            />
