...
const FormPage: React.FC<FormProps> = ({ mode, initialValues, slug }) => {
    ...
    const breadcrumb = [
        { title: 'Management' },
        { title: 'Pages', url: routes.eCommerce.managementPages },
    ...
    return (
        <>
            ...
            <div className="mt-6 mx-6 mb-0">
                <h1 className="text-2xl font-bold mb-4">{mode === 'create' ? 'Create Page' : 'Edit Page'}</h1>
                ...
                <div className='bg-[#fff] min-h-[360px] p-6'>
                    ...
                    <div className="mt-6 flex justify-end">
                        <Button
                            ...
                            label={mode === 'create' ? 'Create Page' : 'Edit Page'}
