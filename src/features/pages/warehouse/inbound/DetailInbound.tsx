...
const DetailInbound = ({ slug, data }: { slug?: any, data: any }) => {
                ...
                <div className='flex flex-col gap-6 min-h-[360px] p-6'>
                    <div className='grid gap-4'>
                        <Card title='Outbound Information' gridcols='md:grid-cols-5 grid-cols-2' >
                            ...
                            <InfoItem label='Terms' value='Net 30' />
                        </Card>
                    </div>
                    <div>
                    ...
                    <div>
                        <div className='flex justify-between my-2'>
                            <h4 className='text-xl font-semibold'>Putaway Tasks</h4>
                        </div>
                        <Table
                            columns={columnsPutawayTask}
                            dataSource={[
                                {
                                    id: 1,
                                    bin: 'BIN-A02',
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                        <div className='col-span-full grid md:grid-cols-[1fr_3fr] gap-4'>
                            <Card title='Financial Links' gridcols='grid-cols-1'>
                                <InfoItem label='AP Bill(s)' value='AP-INV-90231' />
                                <InfoItem label='Landed Cost Allocations' value={
                                    <div>
                                        <div className='flex'>
                                            <span className='w-30'>Freight</span>
                                            <span>AUD $450.00</span>
                                        </div>
                                        <div className='flex'>
                                            <span className='w-30'>Customs Duty</span>
                                            <span>AUD $300.00</span>
                                        </div>
                                    </div>
                                } />
                            </Card>
