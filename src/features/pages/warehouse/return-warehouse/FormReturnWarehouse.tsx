...
const FormReturnWarehouse: React.FC<FormProps> = ({ mode, initialValues, slug }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        return_address: initialValues ? initialValues.return_address : '',
    });
    ...
    const addItem = (list_type: "items" | "receipts") => {
        const newItem: ReturnProductListType = {
            sku: '',
            reference: '',
            qty: 0,
            serial: '',
        ...
        <>
            ...
            <div className="mt-6 mx-6 mb-0">
                <h1 className="text-2xl font-bold mb-4">
                    {mode == 'create' ? 'Create Return (RMA / Reverse Logistics)' : 'Edit Return (RMA / Reverse Logistics)'}
                </h1>
            ...
            <Content className="mb-0">
                <div className='min-h-[360px] p-6'>
                    ...
                    <div className="mt-6 flex justify-end">
                        <Button
                            label={mode == 'create' ? 'Create RMA' : 'Edit RMA'}
...
export default FormReturnWarehouse;
