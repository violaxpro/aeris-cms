...
export const getWidgetColumns = ({
...
}: Columns) => [
  {
    ...
    render: (value: string, row: any) => (
      <Link href="" className="ps-4 hover:text-gray-900 hover:underline">
        #{value}
      </Link>
    ),
  },
  {
    title: (
      <HeaderCell title="PO Number" className="[&>div]:whitespace-nowrap" />
    ),
    dataIndex: 'id',
    key: 'id',
    width: 50,
  ...
  {
    title: <HeaderCell title="Total" className="[&>div]:whitespace-nowrap" />,
    dataIndex: 'id',
    key: 'id',
    width: 50,
    render: (value: string, row: any) => (
